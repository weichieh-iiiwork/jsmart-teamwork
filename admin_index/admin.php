            ...
            <div class="card-deck mb-3 text-center">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body " >
                        ...
                        <p class="mb-2">請按下方按鈕<br>進入管理頁面</p>
                        <p class="mb-5">Please press the button below to enter the back end system page.</p>
                        <input type="button" class="btn btn-lg btn-block btn-info " value="Enter" onclick="location.href='../items/itemAdmin.php'">
                    </div>
                </div>
                <div class="card mb-4 shadow-sm">
                    <div class="card-header">
                    ...
                    <div class="card-body " >
                        ...
                        <p class="mb-2">請按下方按鈕<br>進入管理頁面</p>
                        <p class="mb-5">Please press the button below to enter the back end system page.</p>
                        <input type="button" class="btn btn-lg btn-block btn-info " value="Enter" onclick="location.href='../category/category.php'">
                    </div>
                </div>
                <div class="card mb-4 shadow-sm">
                    <div class="card-header">
                    ...
                    <div class="card-body " >
                        ...
                        <p class="mb-2">請按下方按鈕<br>進入管理頁面</p>
                        <p class="mb-5">Please press the button below to enter the back end system page.</p>
                        <input type="button" class="btn btn-lg btn-block btn-info " value="Enter" onclick="location.href='../member/admin.php'">
                    </div>
                </div>
            </div>
        </div>
